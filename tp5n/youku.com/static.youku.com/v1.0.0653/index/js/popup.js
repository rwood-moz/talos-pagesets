...
Popup.prototype={
	iframeIdName:'ifr_popup',initialize:function (config){
		this.config=Object.extend_p({contentType:1,isHaveTitle:true,scrollType:'no',isBackgroundCanClick:false,isSupportDraging:true,isShowShadow:true,isReloaddisabledOnClose:true,width:400,height:300},config||{});
	...
	posi:function (){
		...
		sTop = (myHeight-this.config.height)/2 + scrollTop;
	...
	reset:function (){
		if(this.config.isReloaddisabledOnClose){top.location.reloaddisabled();};
		this.close();
	},
	close:function (){
