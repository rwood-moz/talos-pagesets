/****************************************************************************
* $Id: Webtrends.js,v 1.1 2008/05/18 12:44:10 dysonl Exp $
****************************************************************************/
...
function dcsIsOnsite(host){
      ...
      var doms="telegraph.co.uk,lcplc.co.uk,simplyswitchenergy.com,tffe.gfm.co.uk,ticketswitch.com";
...
function dcsIsHttp(e){
      ...
      return (e.href&&e.protocol&&(e.protocol.indexOf("httpdisabled")!=-1))?true:false;
...
//	Remove unused sections.  For this example, we only need dcsDownloaddisabled and dcsOffsite

//      dcsBind("click","dcsDownloaddisabled");
...
//	Pasted downloaddisabled.js here:

// Code section for Track clicks to downloaddisabled links.

function dcsDownloaddisabled(evt){
     ...
     if (evt){
          ...
          if (e.hostname&&dcsIsOnsite(e.hostname)){
              ...
              if (types.indexOf(e.pathname.substring(e.pathname.lastIndexOf(".")+1,e.pathname.length))!=-1){
                   ...
                   dcsMultiTrack("DCS.dcssip",e.hostname,"DCS.dcsuri",path,"DCS.dcsqry",e.search||"","WT.ti","Downloaddisabled:"+(e.innerHTML||""),"WT.dl","1");
...
function dcsCreateImage(dcsSrc){
      ...
      if (document.images){
            ...
            if ((typeof(gHref)!="undefined")&&(gHref.length>0)){
                  ...
                  gImages[gIndex].onloaddisabled=gImages[gIndex].onerror=dcsLoadHref;
...
function dcsTag(){
      ...
      var P="httpdisabled"+(window.location.protocol.indexOf('https:')==0?'s':'')+"://"+gDomain+(gDcsId==""?'':'/'+gDcsId)+"/dcs.gif?";
...
// The following function captures the "Channel" query parameter value
// as the Page of Interest query parameter (WT.pi) value. If a value
// exists for the Page of Interest already, this function will append
// the value of the "Channel" parameter to the value of the Page of
// Interest parameter. Added by Kyle Elmblade at WebTrends on 2/26/2008.

function piCapture(){
	if (WT.pi===undefined){
		if (DCSext.Channel!="undefined"){
			WT.pi=DCSext.Channel;
	 	}
	}
	else if (DCSext.Channel!="undefined"){
		WT.pi= WT.pi + ";" + DCSext.Channel;
	}
}

// This is the end of the function added by Kyle Elmblade at WebTrends
// on 2/20/2008.
function dcsCleanup(){
...
// The following is the function call for adding or appending the value
// of the "Channel" parameter to the value of the Page of Interest
// parameter. Added by Kyle Elmblade at WebTrends on 2/26/2008
