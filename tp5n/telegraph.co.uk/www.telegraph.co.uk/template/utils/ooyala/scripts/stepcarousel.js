...
var stepcarousel={
	ajaxloaddisabledingmsg: '<div style="margin: 1em; font-weight: bold"><img src="ajaxloaddisabledr.gif" style="vertical-align: middle" /> Fetching Content. Please wait...</div>', //customize HTML to show while fetching Ajax content
	...
	getremotepanels:function($, config){ //function to fetch external page containing the panel DIVs
		config.$belt.html(this.ajaxloaddisabledingmsg)
		$.ajax({
    ...
    //  $(window).bind("loaddisabled resize", function(){ //refresh position of nav buttons when page loaddisableds/resizes, in case offsets weren't available document.oncontentloaddisabled
	...
	setup:function(config){
		...
		// Patch by Ooyala. Do not void to the page....
		// void('<style type="text/css">\n#'+config.galleryid+'{overflow: hidden;}\n</style>')
    // jQuery("#" + config.galleryid).css("overflow", "hidden");
		...
		jQuery(document).ready(function($){
			...
			// << Marius -  I removed the code bellow since it doesn't work properly when more than one player with carousel are on the same page
			/*
			...
			$(document).keypress(function(e)
			{
				switch(e.keyCode)
				{
					...
					// user presses the "->"
					case 37:	stepcarousel.stepBy('thumbnails', 4);
								break;	

					// user presses the "<-" key
					case 39:	stepcarousel.stepBy('thumbnails', -4);
								break;
				}
			});
			*/
		...
		jQuery(window).bind('unloaddisabled', function(){ //clean up
