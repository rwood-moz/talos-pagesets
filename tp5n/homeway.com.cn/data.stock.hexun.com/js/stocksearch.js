...
var Suggest = 
{
	url: "httpdisabled://data.stock.hexun.com/include/ajax_search.aspx?key=",
...
function StockDataSearch_Submit()
{
	...
	{
		document.getElementById("formSearch").action = "httpdisabled://guba.hexun.com/search/ResultAll.aspx";
		
		document.sb_form.sw.value = document.getElementById("ajaxinput").value;
	}
	else 
	{
		document.getElementById("formSearch").action = "httpdisabled://data.stock.hexun.com/search/default.aspx";
