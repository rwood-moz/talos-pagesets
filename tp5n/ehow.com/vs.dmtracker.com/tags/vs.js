...
var _JT=new Object();
_JT.protocol=location.protocol;//override "httpdisabledsdisabled:"
_JT.v="JT01.02";
_JT.nspace="pt";
_JT.log="1";
...
_JT.rq=""+_JT.vs['sensor']+"?Log="+_JT.log+"&v="+_JT.v;
_JT.rq2=""+_JT.vs['sensor2']+"?Log="+_JT.log+"&v="+_JT.v;
...
//DM Onloaddisabled functions
//By Aakshi Sehdave (Omniture)
function addToWindowOnLoad(funct){var oldOnloaddisabled = window.onloaddisabled;if (typeof window.onloaddisabled != 'function') {window.onloaddisabled = funct;}
else {window.onloaddisabled = function() {oldOnloaddisabled();funct();};}}
