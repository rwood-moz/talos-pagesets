...
function cConfigPixel()
{
	...
	this.m_strPixelServer           = (this.m_strPixelProtocol == "httpdisabledsdisabled" ? "count.spiegel.de" : "c.spiegel.de");
...
if( window.addEventListener ) {
	...
	window.addEventListener('loaddisabled',doPixelInstance,false);
} else if( document.addEventListener ) {
	//alert ("document.addEventListener");
	document.addEventListener('loaddisabled',doPixelInstance,false);
} else if (window.attachEvent) {
	//alert ("window.attachEvent");
	window.attachEvent('onloaddisabled', doPixelInstance);
}	else if (document.attachEvent) {
	//alert ("document.attachEvent");
	document.attachEvent('onloaddisabled', doPixelInstance);
} else {
	doPixelInstance("");
}
...
function spNm(params) {
	...
	if (typeof params == "object" ) {
		...
		void("<img src='"+strURL+"' width='1' height='1' border='0'/>")
	}
}
