...
(function(){
    ...
    function print_shop(theWindow,theDocument,theUrl){
        ...
        if(theWindow.globo_ad_output=="js"){
            void('<script type="text/javascript" src='+ nulify(theUrl) + '><\/script>')
        }
        else if(theWindow.globo_ad_output=="html"){
            if(theWindow.name!="globo_shop_frame"){
                void('<iframe name="globo_shop_frame" width='+nulify(theWindow.globo_shop_width)+" height="+nulify(theWindow.globo_shop_height)+" frameborder="+0+" src="+nulify(theUrl)+' marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no">');
                void("</iframe>");
                void('<script type="text/javascript">var _vitrine = new publicidade.Vitrine();<\/script>')
            }
        }
    ...
    function run(){
        ...
        mywindow.globo_shop_url="httpdisabled://vitrines.globo.com/vitrine/shop.html?";
