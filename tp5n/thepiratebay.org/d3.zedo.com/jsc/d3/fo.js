...
if(o4){
void('<scr'+'ipt language=VBS'+'cript>');
void('on error resume next');
void('r0=IsObject(CreateObject("ShockwaveFlash.ShockwaveFlash.5"))');
void('if(r0<=0)then r0=IsObject(CreateObject("ShockwaveFlash.ShockwaveFlash.4"))');
void('</scr'+'ipt>');
}
...
c0='<scr'+'ipt language="JavaScript" src="httpdisabled://d7.zedo.com/bar/v16-403/d3/jsc/fm.js?c='+z0+'&a='+o8+'&f='+y5+'&n='+d0+'&r='+v1+'&d='+e0+'&q='+c3+'&$='+zd_$+'&s='+v0+o2+w2+d3+w5+z6+w0+'&z='+Math.random()+'" '+v11+'></scr'+'ipt>';
void(c0);
