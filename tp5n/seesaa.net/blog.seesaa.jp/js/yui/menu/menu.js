...
*    <li>Support for 
*    <a href="httpdisabled://en.wikipedia.org/wiki/Progressive_Enhancement">Progressive
...
YAHOO.widget.MenuManager = function() {
    ...
    * menu item.
    * @private
    * @param {<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-
...
* for the menu.
* @param {<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/
...
YAHOO.widget.Menu = function(p_oElement, p_oConfig) {
    ...
    if(p_oConfig) {
        ...
        this.lazyLoad = p_oConfig.lazyLoad || p_oConfig.lazyloaddisabled;
...
/**
* @property lazyLoad
* @description Boolean indicating if the menu's "lazy loaddisabled" feature is 
...
* create the menu.
* @default null
* @type <a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/
* level-one-html.html#ID-94282980">HTMLSelectElement</a>|<a 
* href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-one-html.
...
YAHOO.widget.MenuItem.prototype = {
    ...
    * non-secure images.
    * @default "httpdisabled://us.i1.yimg.com/us.yimg.com/i/"
    * @type String
    */
    IMG_ROOT: "httpdisabled://us.i1.yimg.com/us.yimg.com/i/",
    ...
    * served images.
    * @default "httpdisabledsdisabled://a248.e.akamai.net/sec.yimg.com/i/"
    * @type String
    */
    IMG_ROOT_SSL: "httpdisabledsdisabled://a248.e.akamai.net/sec.yimg.com/i/",
    ...
    * @default null 
    * @private
    * @type <a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-
    ...
    * @default <a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level
    ...
    * @default <a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/
    * level-one-html.html#ID-74680021">HTMLLIElement</a>|<a href="httpdisabled://www.
    * w3.org/TR/2000/WD-DOM-Level-1-20000929/level-one-html.html#ID-38450247"
    * >HTMLOptGroupElement</a>|<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-
    * Level-1-20000929/level-one-html.html#ID-70901257">HTMLOptionElement</a>
    * @type <a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-
    * one-html.html#ID-74680021">HTMLLIElement</a>|<a href="httpdisabled://www.w3.
    ...
    * @return {<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/
    ...
    */
    ...
    /**
    * @method _preloaddisabledImage
    * @description Preloaddisableds an image by creating an image element from the 
    ...
    */
    _preloaddisabledImage: function(p_sPath) {
    ...
    */    
    configChecked: function(p_sType, p_aArgs, p_oItem) {
        ...
        if(bChecked) {
            ...
            this._preloaddisabledImage(this.CHECKED_IMAGE_PATH);
            this._preloaddisabledImage(this.SELECTED_CHECKED_IMAGE_PATH);
            this._preloaddisabledImage(this.DISABLED_CHECKED_IMAGE_PATH);
    ...
    configSubmenu: function(p_sType, p_aArgs, p_oItem) {
        ...
        if(oSubmenu) {
            ...
            if(oSubmenu instanceof Menu) {
                ...
                oSubmenuConfig.lazyloaddisabled = bLazyLoad;
                ...
                oMenu = new this.SUBMENU_TYPE(
                                oSubmenu,
                                { lazyloaddisabled: bLazyLoad, parent: this }                
                            );
            ...
            if(oMenu) {
                ...
                if(!oImg) { 
                    ...
                    this._preloaddisabledImage(this.SUBMENU_INDICATOR_IMAGE_PATH);
                    this._preloaddisabledImage(
	...
	*/
	initDefaultConfig : function() {
        ...
        * @default null
        * @type String|<a href="httpdisabled://www.w3.org/TR/
        ...
        * menu.</li></ul>
        * @default null
        * @type Menu|String|Object|<a href="httpdisabled://www.w3.org/TR/2000/
...
* @param {<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-one-
...
* @default null
* @private
* @type String|<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/leve
...
* the context menu.
* @default null
* @type <a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/level-one-
...
initDefaultConfig: function() {
    ...
    * @default null
    * @type String|<a href="httpdisabled://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/
