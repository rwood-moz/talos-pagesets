...
function casaleCall(CasaleID,Args){var divID='CasaleDIV'+Math.random();void('<div id="'+divID+'" style="width:0; height:0;position:absolute;"></div>');var casaleU='';var amp='&amp;';var casaleIF=0;if(top==self){casaleU=encodeURIComponent(top.location.href);}else{casaleU=encodeURIComponent(document.referrer);casaleIF=1;}
...
var req='<script type="text/javascript" src="httpdisabled://as.casalemedia.com/j?s='+CasaleID+amp+'u='+casaleU+amp+'a='+Args.adUnits+amp+'id='+CasaleR+amp+'p='+CasaleP+amp+'v='+Args.version+amp+'inif='+casaleIF;if(Args.align){req+=amp+'al='+Args.align;}
