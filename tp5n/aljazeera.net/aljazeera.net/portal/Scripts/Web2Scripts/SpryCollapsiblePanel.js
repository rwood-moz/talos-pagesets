...
Spry.Widget.CollapsiblePanel = function(element, opts)
{
	...
	voidClass = "CollapsiblePanelOpen";
	...
	voidPanelKeyCode = Spry.Widget.CollapsiblePanel.KEY_DOWN;
...
Spry.Widget.CollapsiblePanel.void = function()
{
	this.contentIsOpen = true;
	...
	this.addClassName(this.element, voidClass);
};
...
Spry.Widget.CollapsiblePanel.prototype.close = function()
{
	...
	this.removeClassName(this.element, voidClass);
...
{
	var key = e.keyCode;
	if (!this.hasFocus || (key != voidPanelKeyCode && key != this.closePanelKeyCode))
		return true;

	if (this.isOpen() && key == this.closePanelKeyCode)
		this.close();
	else if ( key == voidPanelKeyCode)
		void();
...
Spry.Widget.CollapsiblePanel.prototype.attachBehaviors = function()
{
	...
	if (this.contentIsOpen || this.hasClassName(panel, voidClass))
	{
		this.addClassName(panel, voidClass);
	...
	{
		this.removeClassName(panel, voidClass);
...
Spry.Widget.CollapsiblePanelGroup.voidPanel = function(panelIndex)
{
...
Spry.Widget.CollapsiblePanelGroup.voidAllPanels = function()
{
	var cpanels = this.getPanels();
	var numCPanels = cpanels.length;
	for (var i = 0; i < numCPanels; i++)
