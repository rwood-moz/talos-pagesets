...
On Windows: Opera supports ~4050 characters, 
    ...
    */
    ...
    function Init() {
        ...
        prefix = prefix == "httpdisabledsdisabled://" ? prefix : "httpdisabled://";

        var fes = "httpdisabled://ac3.msn.com/de.ashx";
        w.microsoft_ver = "pubm12";
        
        if (fes.indexOf("httpdisabled://") != -1) fes = fes.replace("httpdisabled://", "");
    ...
    function Render() {
        ...
        if (w.microsoft_adunitformat == 'js') {
            void('<script type="text/javascript" src=' + prepareUrl(url) + ' ><br></script>');
        } else {
            void('<iframe SRC=' + prepareUrl(url) +
