...
dcsMultiTrack("DCS.dcssip",e.hostname,"DCS.dcsuri",pth,"DCS.dcsqry",e.search||"","WT.ti","Downloaddisabled:"+ttl,"WT.dl","20","WT.nv",dcsNavigation(evt));
...
if (e.hostname&&e.href&&e.protocol&&(e.protocol.indexOf("httpdisabled")!=-1)){
var pth=e.pathname?((e.pathname.indexOf("/")!=0)?"/"+e.pathname:e.pathname):"/";
...
var P="httpdisabled"+(window.location.protocol.indexOf('https:')==0?'s':'')+"://"+dcsInit.domain+(dcsInit.dcsid==""?'':'/'+dcsInit.dcsid)+"/dcs.gif?";
for (var N in DCS){
if (DCS[N]){
P+=dcsA(N,DCS[N]);
}
