...
try{typeof XN.env.domain}catch(e){
XN = {env:{domain:window.location.hostname.split('.').reverse().slice(0,2).reverse().join('.')}};        
}
var _udn="track." + XN.env.domain + "";		// (auto|none|domain) set the domain name for cookies
var _uhash="on";		// (on|off) unique domain hash for cookies
var _utimeout="1800";   	// set the inactive session timeout in seconds
var _ugifpath="httpdisabled://track." + XN.env.domain + "/__utm.gif";	// set the web path to the __utm.gif file
...
var _ugifpath2="httpdisabled://www.google-analytics.com/__utm.gif";
if (_udl.hash) _udlh=(_udl.href+'').substring((_udl.href+'').indexOf('#'));
if (_udl.protocol=="httpdisabledsdisabled:") _ugifpath2="httpdisabledsdisabled://ssl.google-analytics.com/__utm.gif";
...
function _uInfo(page) {
 ...
 if ((_userv==0 || _userv==2) && _uSP()) {
  ...
  i.onloaddisabled=function() {_uVoid();}
 }
 if ((_userv==1 || _userv==2) && _uSP()) {
  var i2=new Image(1,1);
  i2.src=_ugifpath2+"?"+"utmwv="+_uwv+s+"&utmac="+_uacct+"&utmcc="+_uGCS();
  i2.onloaddisabled=function() { _uVoid(); }
 }
 return;
}
...
function __utmSetTrans() {
 ...
 for (var ii=0;ii<l.length;ii++) {
  ...
  if ((_userv==0 || _userv==2) && _uSP()) {
   ...
   i[ii].onloaddisabled=function() { _uVoid(); }
  }
  if ((_userv==1 || _userv==2) && _uSP()) {
   i2[ii]=new Image(1,1);
   i2[ii].src=_ugifpath2+"?"+"utmwv="+_uwv+s+"&utmac="+_uacct+"&utmcc="+c;
   i2[ii].onloaddisabled=function() { _uVoid(); }
  }
 }
 return;
}
...
if (_utk && _utk!="" && _utk.length>10) {
 if (window.addEventListener) {
  window.addEventListener('loaddisabled', _uCO, false); 
 } else if (window.attachEvent) { 
  window.attachEvent('onloaddisabled', _uCO);
 }
}
